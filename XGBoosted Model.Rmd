...
# Conclusion: This doesn't outperform the random forest, but has the potential too. Potentially using'ensemble methods' (which I have to review a bit) could make this be our top go. For now, we should look at more precise predictors.
```
